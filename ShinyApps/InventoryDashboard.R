...
ui <- fluidPage(
  ...
  selectInput("Condition", "Select Condition", choices = c("All","New", "New Open Box", "Like New", "Recertified", "Refresh", "Excess")),
  selectInput("Manufacturer", "Manufacturer", choices = c("All", "Cisco", "Plantronics")),
...
server <- function(input, output){
  ...
  file_path <- '/Users/liviobeqiri/Documents/R/R-Programming/InventoryReport.xlsx'
